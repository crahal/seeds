...
edurose_mediation_20181126 <- read.dta13(
  "../data/compound/sample_edurose_mediation_20181126.dta",
...
# Write files
# ---------------------------
write.csv(data, "../data/compound/brand_et_al_sample.csv", row.names = FALSE)
write.csv(data_miss, "../data/compound/brand_et_al_with_missing_sample.csv", row.names = FALSE)
